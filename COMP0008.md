...
MIPS is a _reduced instruction set computer (RISC)_ architecture
since it uses sequences of multiple simple instructions which are easily to encode & decode
and more eaborate operations are less common to use this, instead of using _complex instruction set computers (CISC)_ architecture
e.g. Intel's IA-32
